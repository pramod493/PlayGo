...
namespace CDI
{
	const std::pair<int, double> RamerDouglas::findMaximumDistance(const std::vector<Point2D> &Points)const{
	...
	vector<Point2D> RamerDouglas::simplifyWithRDP(vector<Point2D>& Points, double epsilon)const{
